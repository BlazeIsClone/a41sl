...
const getprofile = require("./util/profile");
const getimageeditor = require("./util/imageeditor");
const getchampion = require("./util/championdata");
const getspotlight = require("./util/spotlight");
...
const spotlight = new getspotlight();
